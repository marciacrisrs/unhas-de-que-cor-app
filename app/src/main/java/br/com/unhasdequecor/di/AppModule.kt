...
import br.com.unhasdequecor.data.vision.nail.GeometryFirstNailSegmenter
...
interface RepositoryModule {
    ...
    @Binds @Singleton fun bindNailSegmenter(impl: GeometryFirstNailSegmenter): NailSegmenter
}
